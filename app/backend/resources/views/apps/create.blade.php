...
@section('subheading', 'Define platform, stack, and coding standards — this context guides your AI agents')

@section('content')

<div class="flex flex-nowrap gap-6 items-start" x-data="appForm(@js($projectPath), null)">

<div class="flex-1 min-w-0 space-y-6">

<form id="app-form" action="{{ route('apps.store', $project) }}" method="POST"
...
<div class="card bg-base-100">
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('apps.index', $project) }}" class="btn btn-ghost btn-sm text-sm text-warm hover:text-navy transition duration-200">Cancel</a>
    </div>
</div>
